...
public class Mob : IMapObject
{
	...
	public virtual void paint(mGraphics g)
	{
		...
		mFont.tahoma_7_green.drawStringBorder(g, this.getTemplate().name, this.x, this.y - h - 17, mFont.CENTER,mFont.tahoma_7);
		mFont.tahoma_7_red.drawStringBorder(g, "["+hp+"/"+getTemplate().hp+"]", this.x, this.y - h - 27, mFont.CENTER, mFont.tahoma_7);
	}
