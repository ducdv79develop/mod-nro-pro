public class Item
{
	...
	// Token: 0x0600044E RID: 1102 RVA: 0x00056000 File Offset: 0x00054200
	private int u(int a)
	{
		int num = 32;
		int num2 = a % 128;
	...
	// Token: 0x0600044F RID: 1103 RVA: 0x0005606C File Offset: 0x0005426C
	private int v(int a)
	{
		int num = 22;
		int num2 = a % 88;
	...
	{
		if ((0 <= template.type && template.type < 6) || template.type == 32 || template.type == 35 || template.type == 11 || template.type == 23 || template.type == 75 || template.type == 24)
		{
			return true;
		}
		return false;
