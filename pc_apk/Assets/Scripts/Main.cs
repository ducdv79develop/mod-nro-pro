...
public class Main : MonoBehaviour
{
	...
	private static string string01 = "0";

	private void Start()
	{
        //if (!ServerListScreen.javaVN.Contains(ServerListScreen.ProtectTCPHost())) { return; }
        Mod.Mod.LoadGame();
        Time.timeScale = 3f;
	...
	{
		bool giamDungLuong = Mod.Mod.giamDungLuong;
		if (giamDungLuong)
		{
			Thread.Sleep(12);
		}
