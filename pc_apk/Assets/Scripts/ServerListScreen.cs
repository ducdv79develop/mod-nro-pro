...
public class ServerListScreen : mScreen, IActionListener
{
	...
	public static string Hex2String(string A_0, object A_1)
	{
		A_1 = 0;
	...
	public static void getServerList(string str)
	{
		...
		//str = "/*NRO GIRL:14.225.253.177:14448:0*/,Local:127.0.0.1:14448:0,0,0";
	...
	public override void paint(mGraphics g)
	{
		...
		int num2 = 2;
		mFont.tahoma_7_white.drawString(g, "v" + GameMidlet.VERSION + "[x" + mGraphics.zoomLevel + "]", GameCanvas.w - 2, num2 + 15, 1, mFont.tahoma_7_grey);
		if (!isGetData || loadScreen)
		{
			if (mSystem.clientType == 1 && !GameCanvas.isTouch)
			{
				//mFont.tahoma_7b_red.drawStringBorder(g, "Đổi Background", GameCanvas.w / 2 - 120, GameCanvas.h - 200, 1, mFont.tahoma_7);
				mFont.tahoma_7_blue1.drawStringBd(g, linkweb, GameCanvas.w - 2, GameCanvas.h - 15, 1, mFont.tahoma_7b_yellow);
				//mFont.tahoma_7_blue.drawStringBorder(g, "Phiên Bản Được Tạo Bởi HairMod - Nro Girl By Jake Emma",GameCanvas.w/2, GameCanvas.h - 15, 1, mFont.tahoma_7b_dark);
			}
			else
			{
				//mFont.tahoma_7b_red.drawStringBorder(g, "Đổi Background", GameCanvas.w / 2 - 120, GameCanvas.h - 200, 1, mFont.tahoma_7);
				mFont.tahoma_7_blue1.drawStringBd(g, linkweb, GameCanvas.w - 2, num2, 1, mFont.tahoma_7b_yellow);
				//mFont.tahoma_7_blue.drawStringBorder(g, "Phiên Bản Được Tạo Bởi HairMod - Nro Girl By Jake Emma", GameCanvas.w / 2, GameCanvas.h - 15, 1, mFont.tahoma_7b_dark);
			}
		}
		else
