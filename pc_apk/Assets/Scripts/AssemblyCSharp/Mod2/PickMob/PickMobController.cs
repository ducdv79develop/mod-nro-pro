								...
								if (flag16)
								{
									...
									if (flag17)
									{
										...
										if (flag19)
										{
											...
											if (flag20)
											{
												Mod.Mod.GotoXY(mobFocus.xFirst, mobFocus.yFirst + 1);
											}
